...
export default function ExamMgmt() {
  ...
  const examsByGrade: Record<string | number, any[]> = {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {grades.map(grade => {
          ...
          const themeMap: Record<number, { border: string, text: string, badge: string }> = {
          ...
          const theme = themeMap[grade] || { border: 'border-gray-500', text: 'text-gray-700', badge: 'bg-gray-100 text-gray-800' }
